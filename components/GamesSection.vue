...
const experiments: Game[] = [
  ...
  },
  {
    ...
    description:
      ...
      "‘The Colour Out of Space’. Developed for the GBJAM 8, it mimics the " +
      "limitations of the Game Boy. But there’s a twist: due to the presence " +
